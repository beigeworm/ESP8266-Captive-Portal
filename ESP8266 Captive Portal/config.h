...
const char *ssidDefault= "monbug";
const char *passwordDefault = "pwntoown";
...
const char *update_usernameDefault = "monbug";
const char *update_passwordDefault = "pwntoown";

const char *ftp_usernameDefault = "monbug";
const char *ftp_passwordDefault = "pwntoown";
const char *ftpenabledDefault = "1";



const char *whiteHatAttack =  "0";
const char *ssidAttack = "monbug";
const char *passwordAttack = "pwntoown";
const char *channelAttack = "10";
const char *hiddenAttack = "0";
...
const char *update_usernameAttack =  "monbug";
const char *update_passwordAttack =  "pwntoown";
const char *ftp_usernameAttack =  "monbug";
const char *ftp_passwordAttack =  "pwntoown";
